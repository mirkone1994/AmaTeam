            ...
            <div class="card border-custom shadow-lg">
                ...
                <div class="card-body">
                    <form novalidate method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="tame_name" class="col-md-4 col-form-label text-md-right">Team Name</label>
                            <div class="col-md-6">
                        ...
                        <div class="form-group row">
                            <label for="nation" class="col-md-4 col-form-label text-md-right">Nation</label>
                            <div class="col-md-6">
                                <input id="nation" type="text" class="form-control @error('nation') is-invalid @enderror" name="nation" value="{{ old('nation') }}">
                                @error('nation')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
